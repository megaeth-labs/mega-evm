...
use crate::{
    common::{base_db, transact, transact_inspected, CALLEE, CONTRACT},
    inspector_common::{
        assert_refused, call_then_stop, countdown_loop_code, db_with_callee, deploy_then_stop,
        limits, limits_with_compute, plain_run_code, try_transact_inspected, REVERTING_INIT_CODE,
        REVIVED_CREATION,
    },
};
use alloy_primitives::{Bytes, U256};
use mega_evm::{test_utils::BytecodeBuilder, InspectorLedger, Lane, MegaHaltReason, MegaSpecId};
use revm::{
