...
//! | Precompile halt | the precompile recording site in `evm/precompiles.rs` | swallow of the unused forwarded envelope; KZG splits executed / destroyed by halt reason; `was_precompile_called` excludes this result from the frame-init burn |
