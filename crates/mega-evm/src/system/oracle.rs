...
/// The keccak256 signature of the `Hint(address,bytes32,bytes)` event emitted by the oracle
/// contract.
///
...
/// signature as `topic[0]`, it invokes [`OracleEnv::on_hint`] with the sender address,
/// user-defined topic, and data.
///
/// The event has three topics:
/// - `topic[0]`: This signature hash (identifies the log as a hint event)
/// - `topic[1]`: The sender address who called `sendHint` (indexed)
/// - `topic[2]`: User-defined hint topic (indexed, passed to `on_hint`)
///
...
pub const ORACLE_HINT_EVENT_SIGHASH: B256 =
    b256!("0x66fb93a1a31643ba6f5b14509e18f3f7b426927b61e0c6c4a9622895388982f1");
...
pub const ORACLE_CONTRACT_CODE_REX2: Bytes =
    bytes!("");

/// The code hash of the oracle contract (version 1.1.0, Rex2+).
pub const ORACLE_CONTRACT_CODE_HASH_REX2: B256 =
    b256!("0x0e6a8f334806bbcbaec9fa02ba8c6674e012ef407e4dbe25146bbc55a249892a");
