...
use alloy_consensus::{Signed, TxLegacy, transaction::RlpEcdsaDecodableTx};
...
pub mod tests {
    use super::*;
    use alloy_primitives::{B256, U256, address, b256, bytes, hex};
    ...
    pub const CREATE2_FACTORY_TX: &[u8] = &hex!(
    ...
    pub const POST_EIP155_CHAIN_1_TX: &[u8] = &hex!(
        "f856808504a817c800830186a0808085608060405226a0fceb37453e90ac5ec2780748b7a4907b1dcfb87708697de2e6be19831938c77ba0224ee4c1aaa6a1490b4e3a1fbed7c5151668a12b6f6e3227c2692a64cf79e81f"
    );
    ...
    pub const POST_EIP155_CHAIN_1337_TX: &[u8] = &hex!(
        "f858808504a817c800830186a08080856080604052820a95a0bea22b3c93e686c12e09c4c519919244bd710de249e2588b22cfb28a2d9ecc22a04b8d3598bae247ce8846aafa41fdaadff2e2154034f5789448bf263d905f20c3"
    );

    /// Non-contract creation transaction (to=0x4242...42, pre-EIP-155, v=27).
    /// Generated: cast mktx --private-key 0x0123..def --legacy
    /// 0x4242424242424242424242424242424242424242
    pub const NON_CONTRACT_CREATION_TX: &[u8] = &hex!(
        "f866808504a817c800825208944242424242424242424242424242424242424242808082072ba094a1d148b08c268261581dd9e90478bae0c937e26eec574809876bdd34de82daa03e2fb4dd2cb99703feeb0da3c3a1062a047f0091aa09610c3a7feecfda6f6bad"
    );
