...
Entries are generated by the release flow from merged PR titles. Fix wording in the release candidate PR while it is open, or, after it merges, by a PR onto the release branch before settlement is dispatched.
