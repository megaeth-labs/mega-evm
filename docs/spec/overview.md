...
- **REX7** — The **unstable** spec, currently open for development. Checkpoint-settled compute gas accounting with gas-clamp enforcement; plain opcodes record no compute gas between checkpoints.
