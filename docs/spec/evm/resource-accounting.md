...
- [Rex7](../upgrades/rex7.md) _(unstable)_ — does not change data-size, KV-update, or state-growth counting; compute-gas settlement moves to checkpoints (see [Compute Gas Accounting](compute-gas.md)).
