...
- [Rex5](../upgrades/rex5.md) refines the KZG error-path compute-gas recording for the unstable spec; see Rex5 §8 for the exact semantic. The stable-spec rules on this page are unchanged.
